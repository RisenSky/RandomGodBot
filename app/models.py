...
from sqlalchemy import Column,Integer,String,Binary, PickleType
...
class DrawProgress(Base):
    ...
    def __init__(self, user_id, text, file_type, file_id, winers_count, post_time, end_time): # chanel_id, chanel_name,
    ...
    def __repr__(self):
        return "<DrawProgress(id='%s', user_id='%s', text='%s', file_type='%s', file_id='%s', winers_count='%s', post_time='%s', end_time='%s')>" % (
            self.id,
            self.user_id,
            # self.chanel_id,
            # self.chanel_name,
...
class DrawNot(Base):
    ...
    def __init__(self, id, user_id, chanel_id, chanel_name, text, file_type, file_id, winers_count, post_time, end_time, channels):
        self.id = id
        self.user_id = str(user_id)
        self.chanel_id = str(chanel_id)
        self.chanel_name = chanel_name
...
class Draw(Base):
    ...
    def __init__(self, id, user_id, message_id, chanel_id, chanel_name, text, file_type, file_id, winers_count, post_time, end_time, channels):
        self.id = id
        self.user_id = str(user_id)
